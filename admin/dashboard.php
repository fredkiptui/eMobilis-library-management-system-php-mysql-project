        ...
        <div class="content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h1 class="header-line text-center" style="background-color: #babccf">ADMIN DASHBOARD</h1>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 rscol-xs-6">
                        <div class="alert alert-info back-widget-set text-center">
                            ...
                            ?>
                            <h3>
                                <?php echo htmlentities($listdcats);?> </h3>
                            Listed Categories
                        </div>
                    </div>
                </div>
                        ...
                        <div id="carousel-example" class="carousel slide slide-bdr" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="assets/img/bk1.jpg" alt="" />
                                </div>
                                <div class="item">
                                    <img src="assets/img/bk2.jpg" alt="" />
                                </div>
                                <div class="item">
                                    <img src="assets/img/bk3.jpg" alt="" />
                                </div>
                            </div>
                            <!--INDICATORS-->
